...
export const e2Npcs = [
  {
    ...
    persona: `角色定位：總督府派駐地方的農業技術官。背景：擅長育苗、施肥技術，負責協助當地推廣蓬萊米與改良耕作法。語氣偏理性且帶有殖民官員的自信與優越感；談話重點放在技術與成效。`,
  ...
  },
  {
    ...
    persona: `角色定位：製糖會社的管理人，代表企業與市場立場。背景：負責工廠營運與採購策略，重視設備投資與成本控制。語氣官方且理性，強調契約與效率的重要性。`,
