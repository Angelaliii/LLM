...
export const faqData: FAQItem[] = [
  ...
  {
    id: "faq-2",
    question: "學生年齡層和使用難度如何設定？",
    answer:
      "系統針對國高中生（12-18歲）設計，提供三種難度模式：基礎模式使用白話文表達，進階模式加入古文元素，挑戰模式則包含史學辯證思考。教師可根據學生程度調整，確保每位學生都能有效學習。",
    category: "education",
  },
  {
    id: "faq-3",
    question: "一堂課可以支援多少學生同時使用？",
    answer:
      "校園版授權支援單一課堂最多 40 位學生同時連線對話，響應速度維持在 2 秒內。系統採用負載均衡設計，確保高峰時段的穩定性。個人版限制單一帳戶使用，免費體驗版則為 3 次對話限制。",
    category: "technical",
  },
  {
    id: "faq-4",
    ...
    answer:
      "是的！我們已在開發漢武帝、唐太宗、宋太祖等重要帝王，以及諸葛亮、蘇軾等文臣學者。預計每季推出 2-3 位新人物。校園版用戶享有優先體驗權，個人版用戶可在發布後免費更新。",
    category: "product",
  },
  {
    id: "faq-5",
    question: "教師需要具備什麼技術能力才能使用？",
    answer:
      "完全無需技術背景！教師只需會基本電腦操作即可。我們提供圖形化管理介面，設定課程主題只需點選選項，學生對話記錄自動匯出 Excel 格式。首次使用提供 30 分鐘線上教學，確保教師快速上手。",
    category: "education",
  },
  {
    id: "faq-6",
  ...
  },
  {
    ...
    answer:
      "學生對話記錄僅儲存於教師管理後台，用於教學評量與學習追蹤。我們嚴格遵循個資法規定，不會將學生資料用於其他用途。家長可隨時要求查看或刪除孩子的學習記錄。所有資料採用加密傳輸與儲存。",
    category: "technical",
  },
  {
    id: "faq-8",
